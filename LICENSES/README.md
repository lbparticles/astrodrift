...
|---|---|---|
| `src/integrators/dopr54_cpu.rs`, `kernels/src/dopr54.rs`, and the DOPR54 hunks in `tests/fixtures/galpy_native/galpy-v1.11.2.patch` | `galpy/util/bovy_rk.c` | [`galpy-bovy-BSD-3-Clause.txt`](galpy-bovy-BSD-3-Clause.txt) |
| `src/integrators/dop853_cpu.rs`, `kernels/src/dop853.rs`, and the DOP853 hunks in `tests/fixtures/galpy_native/galpy-v1.11.2.patch` | `galpy/util/leung_dop853.c`, following the [DOP853 implementation by E. Hairer and G. Wanner, adapted to C by J. Colinge](https://www.unige.ch/~hairer/software.html) | [`galpy-leung-BSD-3-Clause.txt`](galpy-leung-BSD-3-Clause.txt), [`hairer-unige-BSD-2-Clause.txt`](hairer-unige-BSD-2-Clause.txt) |
